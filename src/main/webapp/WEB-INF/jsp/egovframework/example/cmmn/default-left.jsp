...
<script type="text/javascript">
	...
	var leftChkFn = {
		...
		menuClickFn : function(e) {
			...
			var submitCon = $(this).parents()[2],
				$id		  = $(this).parent("li").attr("id");
			
			// 일반 페이지 호출 메서드
			if ($id.indexOf("_") < 0) {
				($(submitCon).hasClass("has_submenu")) ?  submitC.ajaxFn($id) :submitC.pageSubmitFn($id);
			
			// 탭 관련 호출 메서드
			} else {
				if (CmmnField.tabArr.indexOf($id) < 0 ) { 
				...
				// 탭 하이라이트 메서드
				highLightC.activeTabFn.call(this);
				
				// left 메뉴   하이라이트 
				highLightC.activeFn($id)		
			}
	...
	var createC = {
	 ...
	 var highLightC = {
			...
			if (typeof id !=="undefined") {  // ajax에 의한 탭의 id 값
				...
				paramName = (pathNameArr[2].indexOf(".do") > 0) ? pathNameArr[2].substring(0, pathNameArr[2].indexOf(".do")) : "main"
			}
				...
				<div class="sidebar-inner">
					...
					<ul id ="leftUL" class="navi">
						...
						<li id="dataTable" class="has_submenu nlightblue">
							...
							<ul>
								<li id="pieChart"><a href="#">차트</a></li>
								<li id="tableList"><a href="#">테이블</a></li>
								
							</ul>
						</li>
						<li id="tabMenu" class="has_submenu ngreen">
							<a href="#">
